...
// Tu código acá:
const spanCreate = document.querySelector("#createdBy");

spanCreate.innerHTML =  spanCreate.innerHTML + " Sergio A"
...
function buildToDos(toDos) {
  ...
  return toDos.map(buildToDo) //ya está la fun definida arriba, los parametros coinciden con el cb. 
  // var newArray = toDos.map((x, i) =>{
...
$click.addEventListener("click", addToDo)
